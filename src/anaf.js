 ...
 *
 * demoanaf.ro is a demo/mock endpoint and can be down or rate-limited for
 * extended periods (observed returning HTTP 402 repeatedly on 2026-09-25,
 * which blocked every scrape run with no fallback). Mirrors the pattern
 * already proven on the rest of the fleet (Brewtality-3-16's scraper/anaf.js):
 *
